...
Insight.prototype.askPermission = function (msg, cb, options) {
	...
	// ToDO: Add test case, rewrite in JS idiomatic way
	var optInByDefault = true;
	if(options) {
		optInByDefault = !!options.optInByDefault;
	}
	var prompt = inquirer.prompt({
		type: 'confirm',
		name: 'optIn',
		message: msg || defaultMsg,
		default: optInByDefault
	}, function (result) {
	...
	permissionTimeout = setTimeout(function () {
		...
		this.optOut = (options && options.optInByDefault) || true;
		cb(null, false);
